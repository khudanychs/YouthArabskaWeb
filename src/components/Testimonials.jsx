...
function TestimonialCard({ testimonial }) {
  ...
  return (
    <div className="relative flex-shrink-0 w-[300px] sm:w-[360px] md:w-[400px]">
      <div
        className="relative rounded-2xl p-7 sm:p-8 flex flex-col justify-between border border-white/8 overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-3 border-t border-white/8 pt-4 relative z-10">
    ...
    <section ref={sectionRef} className="relative py-20 sm:py-24 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <header ref={headerRef} className="text-center mb-14 sm:mb-16 opacity-0">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-5 leading-tight">
      ...
      <div ref={marqueeRef} className="relative overflow-hidden opacity-0">
        {/* Left fade */}
        <div className="absolute left-0 top-0 bottom-0 w-24 sm:w-40 z-10 pointer-events-none" style={{ background: 'linear-gradient(to right, #070a17, transparent)' }} />
        {/* Right fade */}
        <div className="absolute right-0 top-0 bottom-0 w-24 sm:w-40 z-10 pointer-events-none" style={{ background: 'linear-gradient(to left, #070a17, transparent)' }} />
