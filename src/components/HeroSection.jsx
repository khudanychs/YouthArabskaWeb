      ...
      >
        <div className="max-w-4xl lg:max-w-5xl xl:max-w-6xl">
          ...
          <h1 className="font-serif leading-[1.03] tracking-tight mb-7 sm:mb-9">
            <span
              ref={line1Ref}
              className="block text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold text-white opacity-0"
          ...
          <div ref={ctaRef} className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-5 mb-14 sm:mb-18 lg:mb-20">
            ...
            <a
              ...
              className="px-7 py-3.5 sm:px-9 sm:py-4.5 lg:px-11 lg:py-5 rounded-xl border border-white/15 bg-white/[0.03] text-white hover:bg-white/[0.08] hover:border-white/30 transition-all duration-300 font-semibold text-sm sm:text-base lg:text-lg text-center backdrop-blur-sm opacity-0"
            >
          ...
          <div ref={statsRef} className="flex items-center gap-6 sm:gap-10 lg:gap-14 flex-wrap">
            ...
            <div className="hidden sm:block h-10 w-px bg-gradient-to-b from-transparent via-white/15 to-transparent ml-2" />
            <div className="hidden sm:flex items-center gap-2 text-white/35 text-xs tracking-widest uppercase">
